...
<body>
	...
	<form id="form">
		...
		<div class="block">
			...
			<input name="runningBandID" id="runningBandID" value="7600041837" placeholder="工具运行帮区视图ID，用不到可以不填">
		</div>
		<div class="block">
		...
		<div class="block">
			...
			<input name="userAccount" value="liangzhinuo" placeholder="运行工具的用户的帐号，用不到可以不填">
		</div>
		<div class="block">
			<div class="name">用户名：</div>
			<input name="userName" value="梁沚诺" placeholder="运行工具的用户的用户名，用不到可以不填">
		</div>
		<div class="block">
			<div class="name">用户ID：</div>
			<input name="userID" id="userID" value="10329059" placeholder="运行工具的用户ID，用不到可以不填">
		</div>
		<div class="block">
			<div class="name">accessToken：</div>
			<input name="accessToken" id="accessToken" value="8c4c941fa9a3785be48a817158f4a21a9f72ddb235aabc1f27ddc348b39fba19bc1c909c67603648096754c503198a7126cbcf30905a19ddacfb6da591c461f9" placeholder="运行工具的用户的登录令牌，用不到可以不填">
		</div>
		<div class="block">
		...
		<div class="block">
			...
			<input name="param" id="param" placeholder="工具运行参数，用不到可以不填" value='{"bandId":"7600041837","objID":"7600044378"}'>
		</div>
		<div class="block">
