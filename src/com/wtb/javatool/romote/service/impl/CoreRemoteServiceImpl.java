package com.wtb.javatool.romote.service.impl;
...
public class CoreRemoteServiceImpl extends BaseRemoteService.WtbCoreRemoteServiceBase implements CoreRemoteService {
     ...
     */
    @Override
    public JSONObject getDocumentInfoById(String objID,Long bandId) throws Exception {
...
//        RemoteRequestUtils.addNotNullableParam(params, "gid", gid);
        ...
        RemoteRequestUtils.addNotNullableParam(params, "extend", "{\"currDocumentVersion\":[]}");

        String url = "/core/v4/document/core/{?}";
        //下面是打印测试
        Object o=CONNECTOR.doGet(PROCESS, JSON_RESULT, url, params, objID);
        System.out.println(o);
        return CONNECTOR.doGet(PROCESS, JSON_RESULT, url, params, objID);
    }
...
////        Long gid = ActionTool.getCurrentContext().getGid();
//        RemoteRequestUtils.addNotNullableParam(params, "gid", bandId);
        RemoteRequestUtils.addNotNullableParam(params,"extend","{\"creator\":[\"userAccount\",\"userName\",\"userID\"],\"currDocumentVersion\":[\"storageID\",\"size\"],\"permission\":[],\"organization\":[]}");
//        Long gid = ActionTool.getCurrentContext().getGid();
        RemoteRequestUtils.addNotNullableParam(params, "gid", bandId);
...
//        RemoteRequestUtils.addNotNullableParam(params, "aid", "21419389378723787447");
    ...
    public JSONObject getBandsPath(Long bandId) {
        ...
        try {
            ...
            System.out.println("Hello Hello" + bandId);
